...
public class DisbursementServiceImpl implements DisbursementService {
    ...
    private void writeAuditLog(Long userId, String action, String resource, String details) {
        try {
            ...
            System.err.println("[DisbursementService] Unexpected error writing to audit-management-service: "
                    + ex.getMessage());
        }
    }
    ...
    private void triggerComplianceEvaluation(Long disbursementId, Long requestedBy) {
        try {
            ...
            System.out.println("[DisbursementService] Compliance evaluation triggered for DISBURSEMENT:"
                    + disbursementId + " — Result: "
                    + (result != null ? result.getResult() : "null"));
        } catch (Exception ex) {
            System.err.println("[DisbursementService] Unexpected error triggering compliance for DISBURSEMENT:"
